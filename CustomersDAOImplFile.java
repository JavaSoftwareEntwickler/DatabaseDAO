...
public class CustomersDAOImplFile extends CustomersDAO implements Switchable {
	...
	public ArrayList<Customers> getAllCustomers() {
		...
		try {
			...
			FileReader f = new FileReader("C:\\Users\\max\\Desktop\\DatabaseDAO\\customers1.txt");
			// C:\Users\max\Desktop\DatabaseDAO\CUSTOMERS.txt
			...
			System.out.println("Il file non � stato trovato || Riprova");
		}
	...
	public void insertCustomers(Customers c) {
		...
		do {
			...
			try {
				FileWriter f1 = new FileWriter("C:\\Users\\max\\Desktop\\DatabaseDAO\\CUSTOMERS.txt");
				// C:\Users\max\Desktop\DatabaseDAO\CUSTOMERS.txt
	...
	public void modificaElemento(Customers c) {
		...
		for (int i = 1; i < lista.size(); i++) {
			...
			if (lista.get(i).getId() == cerca) {
				...
				System.out.println("Inserisci nuova et� per la modifica: ");
